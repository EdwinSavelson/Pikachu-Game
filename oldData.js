const oldPikachuData = {
  ...
  //NEW PIKACHU SPRITE
  const newPikachuData = {
    idle: {
        1: { x: 0, y: 0, width: 51, height: 50 },
        2: { x: 51, y: 0, width: 51, height: 50 },
        3: { x: 102, y: 0, width: 51, height: 50 },
        4: { x: 153, y: 0, width: 51, height: 50 },
        5: { x: 204, y: 0, width: 51, height: 50 },
        6: { x: 255, y: 0, width: 51, height: 50 },
        7: { x: 306, y: 0, width: 51, height: 50 },
        8: { x: 357, y: 0, width: 51, height: 50 },
        frameLoop: [1, 2, 3, 4, 5, 6, 7, 8],
    },
    run: {
        1: { x: 0, y: 0, width: 61, height: 50 },
        2: { x: 61, y: 0, width: 61, height: 50 },
        3: { x: 122, y: 0, width: 61, height: 50 },
        4: { x: 183, y: 0, width: 61, height: 50 },
        5: { x: 244, y: 0, width: 61, height: 50 },
        frameLoop: [1, 2, 3, 4, 5],
    }
  }
